    ...
    <>
      <div className="bg-hero-img h-[360px] xl:h-[520px] flex items-center justify-center bg-cover bg-center">
        <div className="text-center">
          ...
          <Link to="/cities" className="w-60 m-auto flex justify-center border-black border bg-blue-700 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded">Find your dream trip!</Link>
        </div>
      </div>
    </>
  )
